...
echo "🧪 Тестируем векторизацию одного файла...\n\n";
...
try {
    ...
    $result = $vectorAnalyzer->vectorCacheManager->storeVectorData($testPath, $testChunks);
    ...
    $searchResult = $vectorAnalyzer->vectorCacheManager->findSimilarContent("ламинат EGGER", 2);
